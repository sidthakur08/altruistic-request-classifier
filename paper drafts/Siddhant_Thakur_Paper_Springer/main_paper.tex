...
%
\titlerunning{Decoding Factors in Altruistic Requests}
%
\author{Siddhant Thakur\inst{1} \and
M.Ramprasath\inst{1}}
%
\authorrunning{S. Thakur et al.}
%
\institute{SRM Institute of Science and Technology, Kattankulathur TN 603203, India  
\email{\{st7037,ramprasm\}@srmist.edu.in}}
%
...
\keywords{Machine Learning  \and Natural Language Processing \and Computational Social Science.}
\end{abstract}
%
%
%
